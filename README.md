# About Project
This is a React application that displays details about TV shows. Data from the data.js file, which has an array of TV show objects, that are used in this.
